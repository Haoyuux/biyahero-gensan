...
import { FileText, Shield, AlertTriangle, Users, Car, CreditCard, Clock, Ban, ArrowLeft } from "lucide-react";

interface TermsAndConditionsPageProps {
  onClose: () => void;
}

export default function TermsAndConditionsPage({ onClose }: TermsAndConditionsPageProps) {
  const lastUpdated = "May 8, 2026";

  return (
    <div className="w-full min-h-[100dvh] bg-white dark:bg-zinc-900 font-sans">
      {/* Header */}
      <div className="sticky top-0 bg-gradient-to-r from-blue-600 to-indigo-600 p-4 z-50">
